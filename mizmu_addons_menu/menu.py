...
ankiweb (https://ankiweb.net/shared/info/331704845)
...
def onSetupMenus(*args):
    ...
    addon_menu = mizmu_menu.addMenu("Partial import from apkg file")
    add_action(addon_menu, "Rate this addon", "Thumb_Up.png", lambda: openLink("https://ankiweb.net/shared/info/331704845"))
